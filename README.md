...
class NathaliaArtigas:
    def __init__(self):
        ...
        self.freelance   = True
        self.runs_daily  = True  # não negociável
```
...
┌─────────────────────────────────────────────────────┐
│                                                     │
│   Corro. Treino. Codifico. Todo dia. Sem exceção.   │
│                                                     │
│   Disciplina em um lugar transborda pros outros.    │
│                                                     │
└─────────────────────────────────────────────────────┘
```
